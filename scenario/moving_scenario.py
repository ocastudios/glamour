...
class Billboard():
    def __init__(self,level):
        self.level = level
        self.image = obj_images.scale_image(pygame.image.load(main_dir+'/data/images/scenario/bathhouse_st/billboard_city/billboard/billboard_city.png').convert_alpha())
