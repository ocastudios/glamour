...
class Menu():
	...
	def main(self):
		...
		self.options = [ widget.Button(self.universe, i[0], (300,i[1]), self.position, i[2],color = (255,84,84)) for i in opt]
...
#						 widget.Button(self.universe, directory.arrow_right,(200,450),self.position,self.NOTSETYET, invert = True)]
	...
	def select_saved_game(self):
		...
		self.options	= [widget.Button(self.universe,t('Or go back to Main Menu'), (245,500),self.position,self.back_to_main,color = (58,56,0))]
	...
	def watching_story(self):
		...
		self.position[1] = p(-600)
		self.options	= []
		self.buttons= [widget.Button(self.universe,directory.arrow_right,(940,270), self.position, self.story.next_frame,color = (58,56,0)),
						widget.Button(self.universe,directory.arrow_right,(-400,270), self.position, self.story.past_frame, invert = True,color = (58,56,0))]
...
class Story_Frame():
	def __init__(self, menu, path):
		...
		if "tutorial" in path:
			...
			GT = widget.GameText
			frame_texts = {
				0:[GT(self.menu.universe,  t("Hello, dear! I'm a fairy godmother and I asked for princess Madelline's help to give you a superb tutorial, okay?"),(757,790), box = (718,218),size="small")],
				1:[GT(self.menu.universe,  t("As you'll soon find out, pressing left or right will move your princess around."),(730,790),box=(718,218),size="small") ],
				2:[GT(self.menu.universe,  t("And pressing the spacebar will allow you to jump."),(730,790),box=(718,218),size="small")],
				3:[GT(self.menu.universe,  t('Ctrl'), (715,231)),
					GT(self.menu.universe,  t("And the Control key will get you a kiss."),(730,790),box=(718,218),size="small")],
				4:[GT(self.menu.universe,  t("If you kiss enemies, they will sometimes be sooo happy as to stop bothering you... for a while."),(730,790),box=(718,218),size="small")],
				5:[GT(self.menu.universe,  t("But be aware that some enemies will respond only to your mouse cursor, and yet others can only be dodged!"),(730,790),box=(718,218),size="small")],
				6:[GT(self.menu.universe,  t("You'll notice that on the upper right side there's a clock. When it points down, it will be time for the ball."),(730,790),box=(718,218),size="small")],
				7:[GT(self.menu.universe,  t("But first we need to find you a beautiful and original look."),(730,790),box=(718,218),size="small")],
				8:[GT(self.menu.universe,  t("And in order to do that, we must visit the castles that lie in the left part of most streets."),(730,790),box=(718,218),size="small")],
				9:[GT(self.menu.universe,  t("That's because they are shops, and in them you'll find the most wonderful dresses, make-up, shoes and accessories!"),(730,790),box=(718,218),size="small")],
				10:[GT(self.menu.universe,  t("Oh! And remember you can switch streets by pressing up when in front of a gate."),(730,790),box=(718,218),size="small")],
				11:[GT(self.menu.universe,  t("Now, once you're at the ball, your look will be compared to those of other princesses, and even with the garments you girls used in previous balls."),(730,790),box=(718,218),size="small")],
				12:[GT(self.menu.universe,  t("If you wear the same outfit as others (or repeat it ball after ball), you'll earn little to no glamour points. It would be a shame."),(730,790),box=(718,218),size="small")],
				13:[GT(self.menu.universe,  t("But, on the other hand, if you show up with an original look, then you may earn lots of glamour points!"),(730,790),box=(718,218),size="small")],
				14:[GT(self.menu.universe,  t("And as you gain glamour points, more and more boys will offer you their hearts. And some day, you may even catch the eyes of Prince Charming himself."),(730,780),box=(750,218),size="small")],
				15:[GT(self.menu.universe,  t("But beware! The enemies on your way may not hurt you, but they can make you dirty. And THAT would certainly cost you lots of glamour points!"),(730,790),box=(718,218),size="small")],
				16:[GT(self.menu.universe,  t("You can get even dirtier if you are caught a second time, and become dirtiest if hit yet again..."),(730,790),box=(718,218),size="small")],
				17:[GT(self.menu.universe,  t("...but event then there's hope. Go back and enter the Bathhouse, and you'll be clean and perfumed in no time!"),(730,790),box=(718,218),size="small")],
				18:[GT(self.menu.universe,  t("But before you go, I've got two more tips to you. First, stay alert to the music! By it you can tell not only what is the stronger enemy around, but how far it is from you."),(700,790),box=(830,218),size="small")],
				19:[GT(self.menu.universe,  t("And finally, there are many secret items in the game, and you should anlock them ASAP. To get you started, try kissing the lion on Make-up Street's zoo."), (710,790),box=(800,218),size="small")],
				20:[GT(self.menu.universe,  t("Now you're good to go! Don't stay idle waiting your dreams come true - go get them, girl!"),(730,790),box=(718,218),size="small")]
			}
		elif "story" in path:
