...
class MousePointer():
	def __init__(self, universe, type = 1):
		self.images_small = utils.img.OneSided(os.path.join(directory.interface,"mouse-icon","pointer2"))
		self.images_big = utils.img.OneSided(os.path.join(directory.interface,"mouse-icon","pointer"))
