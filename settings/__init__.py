...
Snow_White = {
    "skin": "pink",
    "hair": "hair_snowwhite",
    "icon": "princess-icon-apple.png",
    "name": "Snow_White",
}
Cinderella = {
    "skin": "tan",
    "hair": "hair_cinderella",
    "icon": "princess-icon-shoe.png",
    "name": "Cinderella",
}
Rapunzel = {
    "skin": "pink",
    "hair": "hair_rapunzel",
    "icon": "princess-icon-brush.png",
    "name": "Rapunzel",
}
Sleeping_Beauty = {
    "skin": "pink",
    "hair": "hair_sleeping",
    "icon": "princess-icon-spindle.png",
...
if "config" in os.listdir(directory.personal):
    config_file = (
        open(os.path.join(directory.personal, "config"), "r").read().split("\n")
    )
...
def reset_scale(percentage="high", full_screen=False):
    ...
    print(
        "Game resolution: "
        + str(int(round(1440 * scale)))
        + "x"
        + str(int(round(900 * scale)))
    )
    return scale
...
try:
    localization_support = gettext.translation(
        "glamour", directory.locale, [current_locale]
    )
except:
